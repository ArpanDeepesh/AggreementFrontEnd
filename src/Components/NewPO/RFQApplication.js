...
const RFQApplication = ({setUserName ,setUserType }) => {
	...
	useEffect(() => {
		...
		getRequest("api/General/UserItemDropDown", UserProfile.getToken()).then(x => x.json()).then(res => {
			if (res.status === 1) {
...
const handleSubmitAddItem = (e) => {
	...
	return (<>
		<div className="main-content">
			...
			<RFQTemplate rfqId={proposalId} oldFormData={frmData} />
			{/*<div className="table">*/}
			{/*	<div className="row">*/}
